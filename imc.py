def calcular_imc(peso, altura): #declaração das variaveis

imc = peso / (altura ** 2) #conta do imc
return imc
...
# valores do imc e suas categorias
...
#sugestoes de exercicios de acordo com a sua linha do imc
else:
